                ...
                <div className="flex items-center gap-3 flex-1 min-w-0">
                  {tour.mainImage && (
                    <img
                      src={tour.mainImage}
                      alt=""
                      className="w-12 h-9 object-cover rounded shrink-0 cursor-pointer ring-offset-1 hover:ring-2 hover:ring-primary transition-all"
                      title={t("Нажмите для редактирования", "Click to edit")}
...
function ImagePositionPicker({ src, value, onChange, label, hint, height = 200 }: {
  src: string; value: string; onChange: (v: string) => void;
  label: string; hint: string; height?: number;
}) {

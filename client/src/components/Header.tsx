      ...
      <header
        className={`sticky top-0 z-50 transition-all duration-300 ${
          scrolled
            ...
            : "bg-white/90 dark:bg-background/90 backdrop-blur-md border-b border-border/40"
        }`}
      >
          ...
          <div className="flex items-center justify-between h-[68px]">
            ...
            <Link href="/">
              ...
              >
                ...
                <span className="text-xl font-extrabold tracking-tight bg-gradient-to-r from-primary to-cyan-500 bg-clip-text text-transparent">
                  TravelPro
                </span>
              </span>
            </Link>
              ...
              {navLinks.map(link => (
                <Link key={link.href} href={link.href}>
                  ...
                  >
                    {link.label}
                    {isActive(link.href) && (
                      <span className="absolute bottom-0 left-3 right-3 h-0.5 rounded-full bg-gradient-to-r from-primary to-cyan-400" />
                    )}
                  </span>
                </Link>
              ))}
            ...
            <div className="flex items-center gap-1.5">
              <Button
                ...
                className="text-muted-foreground gap-1.5 h-9 px-3 rounded-lg hover:bg-muted/70 transition-all duration-200"
              ...
              {user ? (
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button
                      variant="ghost"
                      className="gap-2 pl-2 pr-3 h-9 rounded-xl hover:bg-muted/70 transition-all duration-200"

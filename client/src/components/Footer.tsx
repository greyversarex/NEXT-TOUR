  ...
  return (
    <footer className="relative mt-24 overflow-hidden" style={{ background: "linear-gradient(160deg, hsl(215 40% 12%) 0%, hsl(220 45% 9%) 100%)" }}>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="rounded-xl overflow-hidden shadow-2xl border border-white/10 h-[260px] w-full">
          <iframe
        ...
        <div className="border-t border-white/8 mt-8 pt-5 text-center text-xs text-white/25">

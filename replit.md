...
### Правила работы — обязательны к соблюдению всегда

- **Этот проект критически важен. Каждая задача выполняется полностью, качественно и ответственно — без исключений.**
- Никогда не делать бегло, поверхностно или "на потом". Каждое изменение — продуманное и завершённое.
- Перед любым изменением — понять последствия. После изменения — протестировать результат.
- Никаких временных заглушек, половинчатых решений или TODO-комментариев в коде.
